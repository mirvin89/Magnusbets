      ...
      {plans.map((plan) => (
        <div
          ...
          className={`relative rounded-xl backdrop-blur-sm transition-all duration-300 ${
            plan.featured
              ? 'border-2 border-cyan-500 bg-gray-800/80 shadow-2xl shadow-cyan-500/20 md:scale-105'
              : 'border border-gray-700/50 bg-gray-800/40 hover:border-gray-600/50'
          }`}
        >
          {plan.badge && (
